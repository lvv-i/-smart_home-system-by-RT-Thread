...
#define PKG_USING_ALI_IOTKIT_PRODUCT_KEY "k1mm5LUFErB"
#define PKG_USING_ALI_IOTKIT_PRODUCT_SECRET "NOMa2hQS3VFgoQPn"
#define PKG_USING_ALI_IOTKIT_DEVICE_NAME "RT_Spark"
#define PKG_USING_ALI_IOTKIT_DEVICE_SECRET "2160401966f4f14aa45215175423e4e1"
